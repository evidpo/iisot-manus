  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'ФИО и должности ответственных за выполнение работ'
      },
      {
        id: 'implementation_dates',
        label: 'Сроки выполнения мероприятий',
        type: 'text',
        required: false,
        placeholder: 'Например, I квартал 2025 года'
      }
    ],
    sections: [
